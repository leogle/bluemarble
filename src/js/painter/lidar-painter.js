(function () {
    paintLidar = function (canvas,center,radioPix,palette,rotate,dataLength,data) {
        ...
        context.arc(center.x,center.y,radioPix,(data[0].Heading+rotate)*Math.PI/180,(data[data.length-1].Heading+rotate)*Math.PI/180);
        context.closePath();
        context.fill();
        //绘制雷达扇形
